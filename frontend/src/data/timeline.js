...
export const timeline = [
  ...
  },
  {
    ...
    skills: ['IA', 'Sistemas Operativos', 'Algoritmos', 'Portugués', 'Investigación'],
    get images() { return loadImages(this.id); },
  },
  {
    id: 'sicecna',
    ...
    skills: ['Laravel', 'PHP', 'MySQL', 'QR Code', 'JWT'],
    get images() { return loadImages(this.id); },
  },
  {
    id: 'rutero',
    ...
    icon: '🛵',
    stats: [
      { label: 'Meses en prod.', value: '1+' },
    ],
    skills: ['React', 'Node.js', 'PostgreSQL', 'Docker', 'JWT'],
    get images() { return loadImages(this.id); },
  },
  {
    id: 'semsis',
