    ...
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800">
      <div className="w-full px-6 sm:px-8 lg:px-16 xl:px-24 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Columna 1: Sobre ti */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-3">Tu Nombre</h3>
          ...
          <div>
            <h3 className="text-white text-lg font-semibold mb-3">Links Rápidos</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#sobre-mi" className="hover:text-blue-400 transition-colors duration-200">
                  Sobre Mí
                </a>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-white text-lg font-semibold mb-3">Sígueme</h3>
